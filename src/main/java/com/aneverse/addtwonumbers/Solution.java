package com.aneverse.addtwonumbers;
...
public class Solution {
    ...
    public static void main(String[] args) {
        ...
        final ListNode listNode2 = new ListNode(8, new ListNode(7, new ListNode(7)));
        final ListNode listNode = addTwoNumbersAtOneStep(listNode1, listNode2);
        System.out.println(listNode.toString());
    }

    public static ListNode addTwoNumbersAtOneStep(ListNode l1, ListNode l2) {
